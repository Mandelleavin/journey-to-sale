...
-- Idempotencja zakup\u00f3w jednorazowych (paczki kredyt\u00f3w)
...
create policy "Service role manages checkout sessions" on public.processed_checkout_sessions for all using (auth.role() = 'service_role');