  ...
  const [history, setHistory] = useState<Msg[]>([
    {
      role: "assistant",
      content:
        "Cześć! Jestem Twoim AI Coachem. Powiedz, w czym mogę pomóc — strategia, oferta, marketing, kolejny krok?",
    },
  ]);
          ...
          <div className="flex items-center gap-2 p-4 border-b border-border">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-muted-foreground">
                {remaining !== null
                  ? `${remaining} wiadomości pozostało dziś`
                  : "Limit 20 wiadomości / dzień"}
              </div>
            </div>
          </div>
