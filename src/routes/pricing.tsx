...
function PricingPage() {
  ...
  return (
    <PageShell title="Wybierz pakiet" subtitle="Każdy plan zawiera dostęp do aplikacji i Generatora Produktu AI.">
      ...
      {/* Gwarancja 90 dni - analiza planu */}
        ...
        <div className="flex items-start gap-4 flex-wrap md:flex-nowrap">
          ...
          <div className="flex-1 min-w-[260px]">
            <h2 className="font-display font-extrabold text-2xl">
              Jeśli w 90 dni nie sprzedasz produktu - przeanalizujemy Twój plan
            </h2>
            ...
            <p className="mt-3 text-sm text-foreground/80 leading-relaxed">
              ...
              nasz zespół przeanalizuje Twój plan, ofertę i lejek sprzedażowy, a następnie
              wskaże konkretne kroki, które pomogą domknąć pierwszą sprzedaż.
            </p>
