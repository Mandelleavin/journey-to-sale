...
const AdminUserProductsRoute = AdminUserProductsRouteImport.update({
  id: '/user-products',
  path: '/user-products',
  getParentRoute: () => AdminRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/admin/user-products': {
      id: '/admin/user-products'
      path: '/user-products'
      fullPath: '/admin/user-products'
    ...
    '/admin/event-logs': {
      id: '/admin/event-logs'
      path: '/event-logs'
      fullPath: '/admin/event-logs'
      preLoaderRoute: typeof AdminEventLogsRouteImport
      parentRoute: typeof AdminRoute
    }
    '/admin/engagement': {
      id: '/admin/engagement'
