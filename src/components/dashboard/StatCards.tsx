    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="relative bg-card rounded-2xl p-4 border border-border shadow-soft">
        ...
        <div className="mt-3 flex items-center gap-2">
          ...
          <div>
            <div className="font-display font-bold text-sm leading-tight">Poziom 2</div>
            <div className="text-xs text-orange font-semibold">Uczeń Akcji</div>
          </div>
        </div>
        <div className="mt-3 text-[11px] text-muted-foreground">Jeszcze 140 XP do poziomu 3</div>
        <div className="mt-1.5 h-1.5 rounded-full bg-muted overflow-hidden">
          <div className="h-full w-[60%] bg-gradient-orange rounded-full" />
        </div>
      </div>
      ...
      <div className="relative bg-card rounded-2xl p-4 border border-border shadow-soft">
        ...
        <div className="mt-2 flex items-baseline gap-1">
          <span className="font-display font-extrabold text-3xl text-foreground">860</span>
          <Zap className="w-4 h-4 text-orange fill-orange" />
        </div>
        <div className="text-xs font-semibold text-green mt-0.5">+120 XP dzisiaj</div>
        <div className="mt-2 h-1.5 rounded-full bg-muted overflow-hidden">
          <div className="h-full w-[72%] bg-gradient-violet rounded-full" />
        </div>
      </div>
      ...
      <div className="relative bg-card rounded-2xl p-4 border border-border shadow-soft overflow-hidden">
        ...
        <div className="mt-2 flex items-end justify-between">
          <div>
            <div className="font-display font-extrabold text-3xl text-foreground">37%</div>
      ...
      <div className="relative bg-card rounded-2xl p-4 border border-border shadow-soft">
        ...
        <div className="mt-2 flex items-center gap-3">
          ...
          <div className="text-xs text-muted-foreground">
            Dzień <span className="font-bold text-foreground">19</span> z 90
          </div>
        </div>
      </div>
    </div>
