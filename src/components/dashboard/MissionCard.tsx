          ...
          <div className="mt-4 flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="font-display font-extrabold text-xl md:text-2xl text-foreground leading-tight">
                Napisz propozycję swojego produktu online
              </h2>
              <p className="text-sm text-muted-foreground mt-1.5">
                Stwórz krótki opis, czym jest Twój produkt i komu pomaga.
              </p>
            </div>
          </div>

          <div className="mt-5 flex items-center gap-3 flex-wrap">
            <Button className="bg-gradient-violet text-primary-foreground shadow-glow hover:opacity-95 hover:bg-gradient-violet rounded-xl px-5 h-11 font-bold uppercase tracking-wide text-xs">
              Wykonaj zadanie
            </Button>
      ...
      <div className="relative">
        <div className="sticky-note float-slow rounded-md p-5 relative">
          ...
          <ul className="mt-3 space-y-2">
            {["Napisz ofertę", "Stwórz stronę", "Przygotuj kampanię"].map((t) => (
          ...
          <div className="mt-4 pt-3 border-t border-ink/15 text-xs text-ink/75 font-hand text-base leading-snug">
            Masz 2 zadania<br />z terminem w tym tygodniu!
          </div>
        </div>
      </div>
    </div>
